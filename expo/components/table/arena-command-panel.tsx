...
const styles = StyleSheet.create({
  ...
  season: { minHeight: 58, flexDirection: 'row', alignItems: 'center', gap: 10, marginTop: 4, padding: 9, borderWidth: 1, borderColor: colors.selectionBorder, borderRadius: 12, backgroundColor: colors.selectionTint },
  seasonIcon: { width: 36, height: 36, borderRadius: 10, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.selectionTintStrong },
