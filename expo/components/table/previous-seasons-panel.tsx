...
const styles = StyleSheet.create({
  panel: { padding: 0, overflow: 'hidden', borderColor: colors.borderAccent },
  header: { flexDirection: 'row', alignItems: 'center', gap: 12, padding: 14 },
  pressed: { opacity: 0.78 },
  iconBox: { width: 40, height: 40, alignItems: 'center', justifyContent: 'center', borderRadius: 12, borderWidth: 1, borderColor: colors.selectionBorder, backgroundColor: colors.selectionTint },
  ...
  seasonButtonActive: { borderColor: colors.primary, backgroundColor: colors.selectionTint },
  ...
  tabActive: { backgroundColor: colors.selectionTint },
  ...
  rankTop: { borderColor: colors.selectionBorder, backgroundColor: colors.selectionTint },
