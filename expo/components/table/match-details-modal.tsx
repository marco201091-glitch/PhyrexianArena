...
type Props = { visible: boolean; match: ArenaMatch | null; onClose: () => void; labels: Record<'title' | 'duration' | 'events' | 'damageDealt' | 'lifeLost' | 'lifeGained' | 'commander' | 'infect' | 'started', string> };

export function MatchDetailsModal({ visible, match, onClose, labels }: Props) {
