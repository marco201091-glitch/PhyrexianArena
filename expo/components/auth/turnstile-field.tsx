...
const styles = StyleSheet.create({
  ...
  button: { minHeight: 62, justifyContent: 'center', alignItems: 'center', borderWidth: 1, borderColor: colors.primary, borderRadius: 12, backgroundColor: colors.selectionTint, paddingHorizontal: spacing.md },
