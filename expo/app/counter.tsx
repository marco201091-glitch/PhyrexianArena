  ...
  if (recap) {
    ...
    return <Screen background="solid">
      <ScrollView contentContainerStyle={styles.setupContent}>
        ...
        <Button label={copy('quickGameExport')} icon="share-outline" onPress={() => void Share.share({ title: '21Life', message: recapText })} />
...
const styles = StyleSheet.create({
  ...
  colorActive: { borderWidth: 3, borderColor: colors.primaryMuted },
  game: { flex: 1, backgroundColor: colors.background },
