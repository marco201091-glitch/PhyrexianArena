...
describe('v7 release version parity', () => {
  it('keeps Web, Expo, native build numbers, locks and legal footer aligned', () => {
    ...
    expect((appConfig.ios as Record<string, unknown>).buildNumber).toBe('70102');
    expect((appConfig.android as Record<string, unknown>).versionCode).toBe(70102);
